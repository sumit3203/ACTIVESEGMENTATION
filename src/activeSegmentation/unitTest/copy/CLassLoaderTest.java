...
class ClassLoaderTest
{
   public static void main(String[] a) {
      ...
      try {
         c = Class.forName("activeSegmentation.unitTest.ClassLoaderTest");
      } catch (Exception e) {
         e.printStackTrace();
      }
      ...
      try {
         c = l.loadClass("activeSegmentation.unitTest.ClassLoaderTest");
      } catch (Exception e) {
         e.printStackTrace();
      }
  	...
  	System.setProperty("plugins.dir","C:\\Applications\\ImageJC2\\plugins");
