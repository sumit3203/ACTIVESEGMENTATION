...
public class Gauss2D_Filter_ implements ExtendedPlugInFilter, DialogListener, IFilter, IFilterViz {
	...
	public final static String SIGMA="Gauss_sigma", LEN="G_len", MAX_LEN="G_MAX", ISSEP="G_SEP", SCNORM="G_SCNORM";
	...
	public static void main (String[] args) {
		Gauss2D_Filter_ filter=new Gauss2D_Filter_();
